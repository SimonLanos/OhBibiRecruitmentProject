...
public class PlayerController : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        {
            float distanceBetweenTouches = (Input.GetTouch(0).position - Input.GetTouch(1).position).magnitude / Mathf.Min(Screen.height, Screen.width);
            Vector2 vectorBetweenTouches = (Input.GetTouch(0).position - Input.GetTouch(1).position);
